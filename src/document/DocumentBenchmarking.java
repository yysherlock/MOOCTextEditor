...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			long basict1 = System.nanoTime();
			for( int i=0 ; i<trials; i++){
				BasicDocument basic = new BasicDocument(text);
				basic.getFleschScore();
			}
			long basict2 = System.nanoTime();
			double time1 = (basict2 - basict1) / 1000000000.0;
			System.out.print(time1);
			
			long efficientt1 = System.nanoTime();
			for( int i=0 ; i<trials; i++){
				EfficientDocument efficient = new EfficientDocument(text);
				efficient.getFleschScore();
			}
			long efficientt2 = System.nanoTime();
			double time2 = (efficientt2 - efficientt1) / 1000000000.0;
			System.out.print("\t");
